<nav class="navbar navbar-expand-lg navbar-light bg-light" id="bar-atas">
    <div class="container">
        <a class="navbar-brand" href="<?= base_url('store') ?>">
            <img src="<?= base_url() ?>/images/logo/klann.png" width="50" alt="logo" loading="lazy">
            <span>KLANN.</span>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav ml-auto">
                ...
                <?php endif ?>
                <?php else : ?>
                <a class="nav-item nav-link mr-3 active" href="<?= base_url('store') ?>">STORE</a>
