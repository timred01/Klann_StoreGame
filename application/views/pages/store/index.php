        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item <?php if ($no <= 1) {
                ...
                <div class="carousel-caption d-none d-md-block  <?= $b['text_color'] ?>">
                    ...
                    <a href="<?= base_url('store/detail/' . $b['product_id']) ?>"
                        class="btn btn-success badge-pill mt-3" style="width:200px">ORDER NOW</a>
                </div>
            </div>
            <?php endforeach ?>
        </div>
                ...
                <div class="card shadow scale">
                    ...
                    <div class="card-body">
                        <center>
                            ...
                            <h3 class="text-warning price mt-4">
                                Rp.<?= number_format($game['price'], 2, ', ', '.'); ?></h3>
                            <a href="<?= base_url('store/detail/' . $game['id']) ?>"
                                class="btn btn-outline-info btn-sm btn-block mt-3">See More</a>
                        </center>
                    </div>
                </div>
            </div>
