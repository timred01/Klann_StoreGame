        ...
        <div class="row mb-2">
            <div class="col">
                <div class="card shadow">
                    ...
                    <h5 class="card-header bg-yellow text-light text-center"><strong>Payment Confirm
                            #<?= $order['invoice'] ?></strong></h5>
                    <div class="card-body">
                        ...
                        <button class="btn btn-success bg-yellow float-right" type="submit">SEND</button>
                        <?= form_close() ?>
                    </div>
                </div>
            </div>
